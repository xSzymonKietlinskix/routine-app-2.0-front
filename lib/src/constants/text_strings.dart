...
const String tRegisterTitle = "What's your name?";
const String tName = "Name";
const String tRegister = "Register";
const String tReTypePassword = "Retype Password";
const String tNoName = "Please enter your name";
const String tNoEmail = "Please enter your email";
const String tNoPassword = "Please enter your password";
const String tWrongName ="Please enter a valid name (length > 2)";
const String tWrongEmail = "Please enter a valid email";
const String tWrongPassword = "Please enter a valid password (at least 6 characters)";
const String tWrongReTypePassword = "Passwords do not match";
